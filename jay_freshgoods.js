...
let cookiesArr = [],
	...
	message;
let allMessage = '';
let shareCode = '9B848928F2D4B69ED7635E3EE47D13E9AD1DAAB9A3E3F6CBAFDE81EEB7393333';
	...
	return new Promise(async resolve => {
		let options = {
			...
			headers: {
				...
				Cookie:
					'cuid=eidIe2798122d1s4GEix%252FuspRjy92JqJ273YghhIs3JZdi%252F4JjftGCWZOLgY3glC5gGXsTY1vGLRKckMeHq2opKqTBNLiayOHJtx2EhExIqlbarZpTFa;' +
					cookie
			}
		};
...
function helpme1() {
	return new Promise(async resolve => {
		let options = {
			...
			body: `functionId=current_activity&body={"shareCode":"9B848928F2D4B69ED7635E3EE47D13E9AD1DAAB9A3E3F6CBAFDE81EEB7393333"}&client=wh5&clientVersion=1.0.0&osVersion=10&uuid=7049442d7e415232`,
			headers: {
				Origin: 'https://h5.m.jd.com',
				Host: 'api.m.jd.com',
				'User-Agent':
