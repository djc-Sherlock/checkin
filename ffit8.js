/**************************************
@Name：微信小程序 ffit8 签到领积分，可以兑换毛巾和蛋白棒
@Author：Sliverkiss
@Date：2023-09-20 08:12:16

使用方法：捉h5.youzan.com域名任意包下的Cookie中的KDTWEAPPSESSIONID=XXXXXXXXXX,填写到ffit_data中,多帐号用@分隔
...
class UserInfo {
    ...
    async signin() {
        try {
            const options = {
                //签到任务调用签到接口
                url: `https://h5.youzan.com/wscump/checkin/checkinV2.json?checkinId=1479428`,
                //请求头, 所有接口通用
