...
[task_local]
1 0 * * * https://raw.githubusercontent.com/wf021325/qx/master/task/wbzj.js, tag=腕表之家签到, enabled=true
====================================
# [青龙面板]
	环境变量  WBZJ_KEY
	WBZJ_KEY = '{"url":"https://ios.xbiao.com/apps/Xbiao/ios-Xbiao-9_5-iPhone11_8-828_1792","ck":"userid=xx; userkey=xx","ua":"Xbiao/9.5 (iPhone; iOS 15.6.1; Scale/2.00)"}'
	环境变量的url   例如：https://ios.xbiao.com/apps/Xbiao/ios-Xbiao-9_5-iPhone11_8-828_1792/home/center/   去掉【/home/center/】就是环境变量的url
====================================


======调试区|忽略======
# ^https:\/\/\w+\.xbiao\.com\/apps\/\w+/.+\/home\/center/$ url script-request-header http://192.168.123.100:8080/wbzj.js
======调试区|忽略======
*/
...
const $ = new Env("腕表之家");
const _key = 'WBZJ_KEY';
$.WBZJ = $.getdata(_key) || ($.isNode() ? process.env.WBZJ_KEY : '');
...
function checkIn() {
    return new Promise((resove) => {
        url = $.WBZJ.url +'/user/publicKey'
        headers = {'User-Agent': $.WBZJ.ua,'Cookie': $.WBZJ.ck,}
