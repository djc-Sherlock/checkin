...
const _0x12fd02 = 1.01,
	...
	_0x36120b =
		'Mozilla/5.0 (iPhone; CPU iPhone OS 16_1_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.40(0x18002831) NetType/WIFI Language/zh_CN',
	...
	async ['request'](_0x3ac25e) {
		...
		while (_0x443799 < _0xf6f71a) {
			try {
				...
				_0x470f4e.name == 'TimeoutError'
					? this.log('[' + _0x28607e + ']请求超时，重试第' + _0x443799 + '次')
					: this.log('[' + _0x28607e + ']请求错误(' + _0x470f4e.message + ')，重试第' + _0x443799 + '次');
			}
		}
		...
		let { statusCode: _0x1b5df3, headers: _0x17efbf, body: _0x4ef21b } = _0x3988ac;
...
class _0x46e11a extends _0x29e3c5 {
	...
	async ['personal_info'](_0x142a7f = {}) {
		...
		try {
			...
			let { result: _0x258ac5, statusCode: _0x2b3822 } = await this.request(_0x3e14e1),
				_0x4b75a8 = _0x5b9b40.get(_0x258ac5, 'code', _0x2b3822);

			if (_0x4b75a8 === 0) {
				_0x13ce61 = this.valid = true;
				let { mobilePhone: _0x29036d, name: _0x4ef046 } = _0x258ac5?.['data'];
				this.name = _0x29036d;
	...
	async ['sign_detail'](_0x2d3ccf = {}) {
		try {
			...
			let { result: _0x53f67a, statusCode: _0x3400c0 } = await this.request(_0x5445f6),
				_0x2f345c = _0x5b9b40.get(_0x53f67a, 'code', _0x3400c0);

			if (_0x2f345c === 0) {
				let { continuityTotal: _0x5c4afd, signInDateList: _0x475358, activityId: _0x4e238a } = _0x53f67a?.['data'],
					_0x41cfa7 = false,
	...
	async ['signIn'](_0x3149cb, _0x524079 = {}) {
		try {
			...
			let { result: _0x86652c, statusCode: _0x1ec383 } = await this.request(_0x27d618),
	...
	async ['points_info'](_0x570aeb = {}) {
		try {
			...
			let { result: _0x18b18e, statusCode: _0x3d7906 } = await this.request(_0x242e85),
				_0x138330 = _0x5b9b40.get(_0x18b18e, 'code', _0x3d7906);

			if (_0x138330 === 0) {
				let { soonExpiredPoints: _0x13ad13, totalPoints: _0x457ec6, expiredTime: _0x5d2366 } = _0x18b18e?.['data'];
				const _0xa1dad4 = {
					notify: true
				};
...
!(async () => {
	...
	.catch(_0x593c66 => _0x5b9b40.log(_0x593c66))
	.finally(() => _0x5b9b40.exitNow());
...
async function _0xb1113d(_0x434d27 = 0) {
	...
	try {
		...
		let { statusCode: _0x3eb8bc, result: _0xe59ae2 } = await _0x287bbf.request(_0xc766d5);
		...
		if (_0xe59ae2?.['code'] == 0) {
			...
			_0xe59ae2?.['commonMsg'] && _0xe59ae2.commonMsg.length > 0 ;

			if (_0xe59ae2[_0x1de1e1]) {
				let _0x5a44f2 = _0xe59ae2[_0x1de1e1];
				_0x5a44f2.status == 0
					? _0x12fd02 >= _0x5a44f2.version
						? ((_0x48cfb0 = true),
						  _0x5b9b40.log(_0x5a44f2.msg[_0x5a44f2.status]),
						  _0x5b9b40.log(_0x5a44f2.updateMsg),
						  _0x5b9b40.log('现在运行的脚本版本是：' + _0x12fd02 + '，最新脚本版本：' + _0x5a44f2.latestVersion))
						: _0x5b9b40.log(_0x5a44f2.versionMsg)
					: _0x5b9b40.log(_0x5a44f2.msg[_0x5a44f2.status]);
			} else {
...
async function _0x5e83c8() {
	...
	try {
		...
		let { statusCode: _0x35d559, result: _0x44c16d } = await _0x287bbf.request(_0x34eac3);
		...
		if (_0x44c16d?.['code'] == 0) {
			...
			for (let _0x5ee6df of _0x44c16d.chdTask.simple) {
				!task_chd_simple_list.filter(_0x458f2c => _0x458f2c.missionDefId == _0x5ee6df.missionDefId && _0x458f2c.missionCollectionId == _0x5ee6df.missionCollectionId)
					.length && task_chd_simple_list.push(_0x5ee6df);
			}

			for (let _0x3f1917 of _0x44c16d.chdTask.pageview) {
				!task_chd_pageview_list.filter(_0x3b115e => _0x3b115e.missionDefId == _0x3f1917.missionDefId && _0x3b115e.missionCollectionId == _0x3f1917.missionCollectionId)
					.length && task_chd_pageview_list.push(_0x3f1917);
			}

			for (let _0x2c188d of _0x44c16d.tkjTask.simple) {
				!task_tkj_simple_list.filter(_0x39c750 => _0x39c750.missionDefId == _0x2c188d.missionDefId && _0x39c750.missionCollectionId == _0x2c188d.missionCollectionId)
					.length && task_tkj_simple_list.push(_0x2c188d);
			}

			for (let _0x188550 of _0x44c16d.tkjTask.pageview) {
				!task_tkj_pageview_list.filter(_0x1b1d5b => _0x1b1d5b.missionDefId == _0x188550.missionDefId && _0x1b1d5b.missionCollectionId == _0x188550.missionCollectionId)
					.length && task_tkj_pageview_list.push(_0x188550);
			}
		}
	} catch (_0x3f3aef) {
...
function _0x584c9b(_0x5946c7) {
	return new (class {
		...
		['time'](_0x1c6cf2, _0x553005 = null) {
			...
			for (let _0x4aac85 in _0x254488)
				new RegExp('(' + _0x4aac85 + ')').test(_0x1c6cf2) &&
					(_0x1c6cf2 = _0x1c6cf2.replace(
						RegExp.$1,
						1 == RegExp.$1.length ? _0x254488[_0x4aac85] : ('00' + _0x254488[_0x4aac85]).substr(('' + _0x254488[_0x4aac85]).length)
					));
